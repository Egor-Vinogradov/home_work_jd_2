...
public class PosDepHibStorage implements IPositionDepartmentStorage {
    private static PosDepHibStorage instance;
    private Session session = HibernateUtil.getSessionFactory().openSession();
    private CriteriaBuilder criteriaBuilder = session.getCriteriaBuilder();

    public static PosDepHibStorage getInstance() {
        if (instance == null) {
            synchronized (PosDepHibStorage.class) {
                instance = new PosDepHibStorage();
            }
        }
        return instance;
    }
